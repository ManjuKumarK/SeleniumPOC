...
//	By checkOut_btn = By.xpath("//button[@name='checkout']");
	...
	@FindBy(xpath = "//button[@name='checkout']") private WebElement checkOut_btn;
	...
	public void Endtoend() {
		...
		addcart.click();
		WebElement checkOut = checkOut_btn;
...
//		JavascriptExecutor js = (JavascriptExecutor) driver;
//		WebElement element = driver.findElement(product1_lnk);
//		js.executeScript("arguments[0].scrollIntoView();", element);
//		driver.findElement(addCart1_btn).click();
//		driver.findElement(addCart2_btn).click();
//		System.out.println("products added");
//		
...
//		
//		String cartValue_1 = driver.findElement(cartValue01_lnk).getText();
//		System.out.println("cartValue_1"+cartValue_1);
//		Assert.assertEquals("Sauce Labs Onesie", cartValue_1);
//		
//		String cartValue_2 = driver.findElement(cartValue02_lnk).getText();
